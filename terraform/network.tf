...
resource "google_dns_record_set" "dns_jupyter" {
  name = "jupyter.${data.google_dns_managed_zone.env_dns_zone.dns_name}"
  type = "A"
  ttl  = 300
...
resource "google_dns_record_set" "dns_vault-internal" {
  name = "vault.${data.google_dns_managed_zone.env_dns_zone.dns_name}"
  type = "A"
  ttl  = 300
